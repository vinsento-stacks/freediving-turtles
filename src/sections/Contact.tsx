        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div ref={leftColRef}>
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                <a
                  href="#"
                  className="w-12 h-12 rounded-full bg-[#12263F] flex items-center justify-center text-white/70 hover:text-[#FF6A3D] hover:bg-[#12263F]/80 transition-all duration-200 hover:-translate-y-0.5"
                >
          ...
          <div ref={rightColRef}>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="name" className="block text-[#A9B6C7] text-sm mb-2">
                  Name
                </label>
                <input
                  type="text"
                  ...
                  className="w-full bg-[#12263F] border border-[#1e3a5f] rounded-[14px] px-4 py-3 text-white placeholder-[#A9B6C7]/50 focus:outline-none focus:border-[#FF6A3D] focus:ring-1 focus:ring-[#FF6A3D] transition-all"
              ...
              <div>
                <label htmlFor="email" className="block text-[#A9B6C7] text-sm mb-2">
                  Email
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="message" className="block text-[#A9B6C7] text-sm mb-2">
                  Message
                </label>
                <textarea
                  id="message"
                  ...
                  rows={4}
                  className="w-full bg-[#12263F] border border-[#1e3a5f] rounded-[14px] px-4 py-3 text-white placeholder-[#A9B6C7]/50 focus:outline-none focus:border-[#FF6A3D] focus:ring-1 focus:ring-[#FF6A3D] transition-all resize-none"
        ...
        <div className="mt-20 pt-8 border-t border-[#1e3a5f]/50">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              <a href="#" className="text-[#A9B6C7] text-sm hover:text-white transition-colors">
                Privacy Policy
              </a>
              <a href="#" className="text-[#A9B6C7] text-sm hover:text-white transition-colors">
                Terms of Service
